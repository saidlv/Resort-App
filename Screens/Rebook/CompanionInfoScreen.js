...
function CompanionInfoScreen() {
  ...
  const [isCampanion, setIsCampanion] = useState(false);
  const genderList = [
    ...
    <View style={styles.screen}>
      <View style={styles.HeaderContainerStyle}>
        <TouchableOpacity
          ...
          onPress={function () {
            navigation.navigate('RebookGeneralInformationScreen');
          }}>
      ...
      <View style={styles.screen}>
        <View style={styles.HeaderTitleContainerStyle}>
          <Text style={styles.HeaderTitleTextStyle}>Companion Info</Text>
        </View>
        <View style={styles.CampanionSwitchContainerStyle}>
          <View style={styles.CampanionSwitchSubContainerStyle}>
            <Text
              style={{
                ...styles.TextInputTitleStyle,
                marginTop: 5,
                marginHorizontal: 10,
              }}>
              No Campanion
        ...
        <ScrollView style={styles.InformationContainerStyle}>
          ...
          <TouchableOpacity
            ...
            onPress={function () {
              navigation.navigate('RebookRoomSelectionScreen');
            }}>
...
const styles = StyleSheet.create({
  ...
  CampanionSwitchContainerStyle: {
    flexDirection: 'row',
    justifyContent: 'center',
    backgroundColor: '#F8F9FB',
    paddingVertical: 10,
  },
  CampanionSwitchSubContainerStyle: {
    flexDirection: 'row',
  },
});
